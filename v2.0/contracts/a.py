...
def convolution_operation_batch_3D_images(input_image_batch, kernel, stride, pad):
    """
    ...
    batch_size, input_height, input_width, input_channels = input_image_batch.shape
    ...
    batch_padded_image = np.pad(input_image_batch, ((
        0, 0), (pad, pad), (pad, pad), (0, 0)), mode='constant', constant_values=(0, 0))
        ...
        for h in range(output_height):
            ...
            for w in range(output_width):
                ...
                for c in range(num_filters):
                    ...
                    image_patch = current_padded_image[h_start:h_end,
                                                       w_start:w_end, :]
                    final_output[index, h, w, c] = conv_step(
                        image_patch, kernel[c, ...])
    return final_output
